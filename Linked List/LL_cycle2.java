public class LL_cycle2 {
    ...
    // tell where the cycle starts from( return Node ) ?
    ...
    // detect cyclic Node for LeetCode
    public void detectNode(Node listHead){ // yeh pta nhi  kyu galat hai
